...
az vm image terms accept --urn cisco:cisco_cloud_vwan_csr:cisco_cloud_vwan_csr_17_3_0_2938:17.5.01
...
#create lb, front end vip, health check, HA ports, floating IP
...
az network lb rule create --resource-group $rg --lb-name csr-lb -n MyHAPortsRule  --protocol All --frontend-port 0 --backend-port 0 --backend-pool-name csr-backendpool --floating-ip true --probe-name myHealthProbe
...
az vm create --resource-group $rg --location $loc --name csr1 --size Standard_DS3_v2 --nics csr1-vpn0 csr1-service --image cisco:cisco_cloud_vwan_csr:cisco_cloud_vwan_csr_17_3_0_2938:17.5.01 --admin-username azureuser --admin-password Msft123Msft123 --no-wait
...
az vm create --resource-group $rg --location $loc --name csr2 --size Standard_DS3_v2 --nics csr2-vpn0 csr2-service --image cisco:cisco_cloud_vwan_csr:cisco_cloud_vwan_csr_17_3_0_2938:17.5.01 --admin-username azureuser --admin-password Msft123Msft123 --no-wait
