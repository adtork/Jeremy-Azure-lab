...
az vm create --resource-group $rg --location $loc --name csr1 --size Standard_DS3_v2 --nics csr1-vpn0 csr1-service --image cisco:cisco-csr-1000v:17_3_3-byol:17.3.320210317 --admin-username azureuser --admin-password Msft123Msft123 --no-wait
...
az vm create --resource-group $rg --location $loc --name csr2 --size Standard_DS3_v2 --nics csr2-vpn0 csr2-service --image cisco:cisco-csr-1000v:17_3_3-byol:17.3.320210317 --admin-username azureuser --admin-password Msft123Msft123 --no-wait
