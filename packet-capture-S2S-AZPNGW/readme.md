...
Below is an example of the pcap in wireshark filtering on UDP port 4500, BGP or ICMP. You can see the outer IPSEC information as well as the inner BGP session and ICMP that is running between the VMs. 
Key IPs:
